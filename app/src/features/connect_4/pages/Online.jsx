...
export default function OnlineConnect4() {
    ...
    */
    ...
    if (winner === 'red') {
        ...
        if (evenMoves)
            status = "Playing as blue - Your turn";
        else
            status = "Playing as red - Your turn";
    } else {
        if (evenMoves)
            status = "Playing as red - Not your turn";
        else
            status = "Playing as blue - Not your turn";
    }
    ...
    async function handleClick(index) { // index is column (between 0 and 6)
